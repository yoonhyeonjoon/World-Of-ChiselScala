package semifiveHomework.allen
...
class Controller(width: Int)(implicit p: Parameters) extends LazyModule  with LazyScope{
  ...
  override lazy val desiredName = "rocketChipExamples.Controller"
}
...
//  }
  ...
  override lazy val desiredName = "rocketChipExamples.Calculator"
}
...
class ObsoltedSubModule()(implicit p: Parameters) extends LazyModule {
  //new rocketChipExamples.CalculatorSinkNode(Seq(rocketChipExamples.UpwardParam(8)))
...
//  om {
//    OM.AddressBlock.name := "Logical Part : rocketChipExamples.SubModule is added for my example"
//  }
...
//      OM.AddressBlock.name := "Physical Part : rocketChipExamples.SubModule is added for my example"
...
//    }
  ...
  override lazy val desiredName = "rocketChipExamples.SubModule"
}
...
class Adder(implicit p: Parameters) extends LazyModule {
  ...
  override lazy val desiredName = "rocketChipExamples.Adder"
}
...
//    }
  ...
  override lazy val desiredName = "rocketChipExamples.ComplexAdderTestHarness"
}
