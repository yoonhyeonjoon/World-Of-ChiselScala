...
class QueueV5(numEntries: Int, bitWidth: Int) extends Module {
...
object QueueV5 extends App {
  def simCycle(qm: QueueModel, c: QueueV5, enqValid: Boolean, deqReady: Boolean, enqData: Int=0) {
