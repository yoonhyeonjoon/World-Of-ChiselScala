...
import Chisel.{Decoupled, fromBooleanToLiteral, fromtIntToLiteral}
import chisel3.util.Queue
import chisel3.util.random.FibonacciLFSR
import chisel3.{Bool, Bundle, Input, Module, Output, UInt, WireInit, when}


class ComplexQueue(maxVal: Int, numEntries: Int, pipe: Boolean, flow: Boolean) extends Module {
